...
/**
 * Created by Clarissa on 12/1/16.
 */

public class FetchMovieRecommendationsTask extends AsyncTask<String, Void, String> {
    private final String LOG_TAG = FetchMovieRecommendationsTask.class.getSimpleName();
    ...
    public FetchMovieRecommendationsTask(Activity activity, User user, SearchSubscriber searchSubscriber) {
    ...
    protected void onPreExecute() {
        this.dialog.setMessage("Fetching recommendations...");
        this.dialog.show();
    }
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            String SEARCH_BASE_URL =
                    "http://ec2-35-165-1-224.us-west-2.compute.amazonaws.com:8080/movie/recommendations?";
    ...
    public void onPostExecute(String result) {
        if (result != null) {
            ...
            this.searchSubscriber.notifyResult(result);
        } else {
